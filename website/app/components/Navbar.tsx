...
function Navbar() {
    ...
    return (
        <nav className="container mx-auto px-6 md:px-10 py-6 relative">
        <div className="flex items-center justify-between">
            ...
            >
                ...
                <Image src='/images/logo.png' alt="logo" className="w-28 md:w-36 h-full" width={400} height={400} />
            </motion.div>
            ...
            {
                isLogged ? (
                    <div className="items-center gap-4 hidden md:flex z-50">
        ...
        {/* Mobile Menu */}
        <motion.div
            className={`md:hidden z-50 absolute top-full left-0 right-0 bg-[#1A1033] p-4 space-y-4 ${
        ...
        >
            <Link href="/how-it-works" className="block hover:text-purple-400 transition">
                How It Works
            </Link>
            <Link href="#" className="block hover:text-purple-400 transition">
                Explore Drops
            </Link>
            <Link href="/creators" className="block hover:text-purple-400 transition">
                Creators
            </Link>
            <Link href="/about" className="block hover:text-purple-400 transition">
                About
            </Link>
            {
                isLogged ? (
